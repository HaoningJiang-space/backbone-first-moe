...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    py::class_<ArcherPrefetchHandle>(m, "prefetch_handle")
        ...
        .def("get_node_byte_size", &ArcherPrefetchHandle::GetNodeByteSize)
        .def("get_device_free_memory", &ArcherPrefetchHandle::GetDeviceFreeMemory)
        .def("get_device_memory_capacity", &ArcherPrefetchHandle::GetDeviceMemoryCapacity)
        .def("get_sparse_cache_limit", &ArcherPrefetchHandle::GetSparseCacheLimit)
        ...
        .def("pin_resident_nodes", &ArcherPrefetchHandle::PinResidentNodes)
